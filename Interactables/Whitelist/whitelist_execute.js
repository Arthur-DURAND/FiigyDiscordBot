...
module.exports = {
	name: "whitelist_execute",
	async execute(interaction) {

        try {

            logs.debug(interaction.guild,interaction.user,"whitelist_execute",null)
            ...
            callback = function(response) {
              ...
              response.on('end', async function () {
                ...
                if (user) {
                  await user.update({uuid: uuid, pseudo: username})
                } else {
                ...
                logs.info(interaction.guild,interaction.user,"whitelist_execute","Wl finie : "+username)
			...
			if(interaction)
				logs.error(interaction.guild,interaction.user,"whitelist_execute",error)
			else
				logs.error(null,null,"whitelist_execute",error)
		}
    }
};